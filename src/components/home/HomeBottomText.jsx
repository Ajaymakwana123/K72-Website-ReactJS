...
const HomeBottomText = () => {
  ...
  return (
    <div className='font-[font2] flex items-center justify-center gap-4 '>
      <p className='absolute lg:w-[17vw] w-64 right-0 bottom-54 lg:bottom-48 font-[font2] lg:text-[0.9rem] text-[2.6vw] lg:leading-relaxed leading-tight'>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-34 flex items-center px-1 pt-1 lg:px-8 border-white rounded-full uppercase'>
        <Link className='text-[5.5vw] lg:mt-3' to='/projects'>Projects</Link>
      </div>

      <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-34 flex items-center px-1 pt-1 lg:px-8 border-white rounded-full uppercase'>
        <Link className='text-[5.5vw] lg:mt-3' to='/agence'>agence</Link>
      </div>
